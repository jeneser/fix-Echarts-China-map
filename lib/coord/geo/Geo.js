...
var parseGeoJson = require("echarts/lib/coord/geo/parseGeoJson");

var View = require("echarts/lib/coord/View");

var fixTextCoord = require("echarts/lib/coord/geo/fix/textCoord");

var fixGeoCoord = require("echarts/lib/coord/geo/fix/geoCoord");

// fix island
var fixDiaoyuIsland = require("./fix/diaoyuIsland");
var fixDongshaIsland = require("./fix/dongshaIsland");
...
*/
// Geo fix functions
var geoFixFuncs = [fixNanhai, fixTextCoord, fixGeoCoord, fixDiaoyuIsland, fixDongshaIsland];
/**
 * [Geo description]
